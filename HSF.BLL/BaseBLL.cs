...
namespace HSF.BLL
{
    ...
    {
        public IBaseDAL<T> BaseRepository { get; set; }
        #region CRUD
        /// <summary>
        /// 根据主键返回实体
        /// </summary>
        ...
        /// 根据条件删除
        /// </summary>
        public bool DeleteByWhere(string where, object param)
        {
            return BaseRepository.DeleteByWhere(where, param) > 0 ? true : false;
        }
        #endregion
        /// <summary>
        /// 获取分页数据
